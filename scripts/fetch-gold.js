/* altinkaynak.com canlı verisinden altın SATIŞ fiyatlarını çeker,
...
// altinkaynak Kod -> uygulama türü (Satış fiyatı kullanılır)
const GOLD_MAP = {
  "Çeyrek": "C",
  "Yarım": "Y",
  "Ata / Tam": "A_T",
...
(async () => {
  ...
  try {
    ...
    if (c.USD) usd = trNum(c.USD.Satis);
    if (c.EUR) eur = trNum(c.EUR.Satis);
  } catch (e) {}
